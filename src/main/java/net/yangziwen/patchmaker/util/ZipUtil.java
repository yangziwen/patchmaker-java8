...
public class ZipUtil {
	...
	public static void zip(File[] sourceFiles, String zipPath, String encoding) {
		try (ZipOutputStream zipOut = new ZipOutputStream(new BufferedOutputStream(new FileOutputStream(zipPath)))) {
	...
	private static void doZip(ZipOutputStream zipOut, File sourceFile, String sourceRootPath) {
		...
		try (BufferedInputStream bufferedInput = new BufferedInputStream(new FileInputStream(sourceFile))) {
