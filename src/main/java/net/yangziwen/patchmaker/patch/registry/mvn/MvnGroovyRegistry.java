...
public class MvnGroovyRegistry extends AbstractRegistry {
	
	private static final String PACKAGE_PREFIX = "/src/main/java/";
	
	public MvnGroovyRegistry(){
		super(GROOVY_FILTER);
	}
	...
	protected boolean fillFileMapping(String srcPath, String patchRootPath, Map<File, File> fileMapping) {
		...
		String classFileName = srcPath.substring(packageEndPos).replace(".groovy", ".class");
